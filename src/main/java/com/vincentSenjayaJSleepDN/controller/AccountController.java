...
public class AccountController implements BasicGetController<Account>
{
    ...
    @JsonAutowired(value = Account.class, filepath = "C:\\Users\\vince\\Prak OOP\\ProyekOOP\\JSleep\\src\\main\\java\\com\\json\\account.json")
    ...
    public Account getByEmail(@RequestParam String email, @RequestParam String password) {
        try {
            MessageDigest md = MessageDigest.getInstance("MD5");
            md.update(password.getBytes());
            byte[] bytes = md.digest();
    ...
    Renter register(@PathVariable int id, @RequestParam String username, @RequestParam String address,
                    @RequestParam String phoneNumber) {
        Account account = BasicGetController.super.getById(id);
        if (account.renter == null && account.id == id) {
